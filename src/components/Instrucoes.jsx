...
  return (
    // O 'div' externo agora tem o fundo branco fixo
    <div className="min-h-screen bg-white">
      {/* O 'div' interno muda de cor para o modo noturno */}
      <div className={`w-full max-w-[1440px] mx-auto min-h-screen p-4 lg:p-0 ${isDarkMode ? "bg-[#144774] text-white" : "bg-white text-[#144774]"}`}>
        
...
          <h1 className={`font-madimione text-center text-2xl lg:text-4xl my-8 lg:my-20 ${isDarkMode ? "text-white" : "text-[#144774]"}`}>
